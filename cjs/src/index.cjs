...
const GetServers_js_1 = require("./Commands/GetServers.cjs");
Object.defineProperty(exports, "GetServers", { enumerable: true, get: function () { return GetServers_js_1.GetServers; } });
const GetApiKeys_js_1 = require("./Commands/GetApiKeys.cjs");
